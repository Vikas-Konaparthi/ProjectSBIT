...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title id="pageTitle">SBIT TPO Login.com </title>
...
<div class="container">
    ...
    <div class="row">
        <img src = "sbit-khammam4.jpg" style="margin-left: auto; margin-right: auto; width: 50%; display: block; margin-top: 50px; margin-bottom: 50px;">
        <div id="formContainer" class="" style="float: none;margin: 0 auto;">
            <form id="login" name="login" title="login form" role="form" method="post" action="register.php">
                <br>
                <br>
                <h2 style="text-align: center;margin-top: 10px; color:#273746;" class="form-signin-heading">Register</h2>
